...
class DelegateTest {
    ...
    fun `test CanonPrinter`() {
        assertLogContains(Level.INFO, "Canon Printer : Test Message Printed") {
    ...
    @Test
    fun `test HpPrinter`() {
        assertLogContains(Level.INFO, "HP Printer : Test Message Printed") {
    ...
    fun `test EpsonPrinter`() {
        assertLogContains(Level.INFO, "Epson Printer : Test Message Printed") {
            PrinterController(HpPrinter()).print(MESSAGE)
        }
    }
}