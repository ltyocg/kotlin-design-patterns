...
class DelegateTest {
    ...
    fun `test CanonPrinter`() {
        ...
        assertEquals("Canon Printer : Test Message Printed", assertListAppender.formattedList().lastOrNull())
    }
    ...
    fun `test HpPrinter`() {
        ...
        assertEquals("HP Printer : Test Message Printed", assertListAppender.formattedList().lastOrNull())
    }
    ...
    fun `test EpsonPrinter`() {
        ...
        assertEquals("Epson Printer : Test Message Printed", assertListAppender.formattedList().lastOrNull())
    }
}